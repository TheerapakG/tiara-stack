...
export class ClientService extends Effect.Service<ClientService>()("ClientService", {
  ...
  static fromInteraction = (interaction: Interaction) => ClientService.Default(interaction.client);
}
