...
export const tapify = <In, Out, E1, R1>(f: (_: In) => Effect.Effect<Out, E1, R1>) =>
  Function.dual<
    <O>(
      transform: (object: NoInfer<O>) => NoInfer<In>,
    ) => <E2, R2>(self: Effect.Effect<O, E2, R2>) => Effect.Effect<O, E1 | E2, R1 | R2>,
    <O, E2, R2>(
  ...
  >(
    2,
    <O, E2, R2>(self: Effect.Effect<O, E2, R2>, transform: (object: NoInfer<O>) => NoInfer<In>) =>
      pipe(
        self,
...
export const tapErrorify = <In, Out, E1, R1>(f: (_: In) => Effect.Effect<Out, E1, R1>) =>
  Function.dual<
    <O>(
      transform: (object: NoInfer<O>) => NoInfer<In>,
    ) => <A2, R2>(self: Effect.Effect<A2, O, R2>) => Effect.Effect<A2, E1 | O, R1 | R2>,
    <O, A2, R2>(
  ...
  >(
    2,
    <O, A2, R2>(self: Effect.Effect<A2, O, R2>, transform: (object: NoInfer<O>) => NoInfer<In>) =>
      pipe(
        self,
...
export const tapifyOptional = <In, Out, E1, R1>(f: (_?: In) => Effect.Effect<Out, E1, R1>) =>
  Function.dual<
    <O>(
      transform?: (object: NoInfer<O>) => NoInfer<In>,
    ) => <E2, R2>(self: Effect.Effect<O, E2, R2>) => Effect.Effect<O, E1 | E2, R1 | R2>,
...
export const tapErrorifyOptional = <In, Out, E1, R1>(f: (_?: In) => Effect.Effect<Out, E1, R1>) =>
  Function.dual<
    <O>(
      transform?: (object: NoInfer<O>) => NoInfer<In>,
    ) => <A2, R2>(self: Effect.Effect<A2, O, R2>) => Effect.Effect<A2, E1 | O, R1 | R2>,
...
export const tapEffectify = <In, Out, E1, R1>(f: (_: In) => Effect.Effect<Out, E1, R1>) =>
  Function.dual<
    <O, E2, R2>(
      transform: (object: NoInfer<O>) => Effect.Effect<NoInfer<In>, E2, R2>,
    ) => <E3, R3>(self: Effect.Effect<O, E3, R3>) => Effect.Effect<O, E1 | E2 | E3, R1 | R2 | R3>,
    <O, E2, R2, E3, R3>(
...
export const tapEffectifyOptional = <In, Out, E1, R1>(f: (_?: In) => Effect.Effect<Out, E1, R1>) =>
  Function.dual<
    <O, E2, R2>(
      transform?: (object: NoInfer<O>) => Effect.Effect<NoInfer<In>, E2, R2>,
    ) => <E3, R3>(self: Effect.Effect<O, E3, R3>) => Effect.Effect<O, E1 | E2 | E3, R1 | R2 | R3>,
  ...
  >(
    ...
    <O, E2, R2, E3, R3>(
      ...
      pipe(
        self,
        Effect.tap((a) => pipe(transform?.(a) ?? Effect.succeed(undefined), Effect.flatMap(f))),
      ),
  );

export const tapErrorEffectify = <In, Out, E1, R1>(f: (_: In) => Effect.Effect<Out, E1, R1>) =>
  Function.dual<
    <O, E2, R2>(
      transform: (object: NoInfer<O>) => Effect.Effect<NoInfer<In>, E2, R2>,
    ) => <A3, R3>(self: Effect.Effect<A3, O, R3>) => Effect.Effect<A3, E1 | E2 | O, R1 | R2 | R3>,
    <O, E2, R2, A3, R3>(
...
export const mapify = <In, Out, E1, R1>(f: (_: In) => Effect.Effect<Out, E1, R1>) =>
  Function.dual<
    <O>(
      transform: (object: NoInfer<O>) => NoInfer<In>,
    ) => <E2, R2>(self: Effect.Effect<O, E2, R2>) => Effect.Effect<Out, E1 | E2, R1 | R2>,
    <O, E2, R2>(
      self: Effect.Effect<O, E2, R2>,
      transform: (object: NoInfer<O>) => NoInfer<In>,
...
export const mapifyOptional = <In, Out, E1, R1>(f: (_?: In) => Effect.Effect<Out, E1, R1>) =>
  Function.dual<
    <O>(
      transform?: (object: NoInfer<O>) => NoInfer<In>,
    ) => <E2, R2>(self: Effect.Effect<O, E2, R2>) => Effect.Effect<Out, E1 | E2, R1 | R2>,
...
export const mapEffectify = <In, Out, E1, R1>(f: (_: In) => Effect.Effect<Out, E1, R1>) =>
  Function.dual<
    <O, E2, R2>(
      transform: (object: NoInfer<O>) => Effect.Effect<NoInfer<In>, E2, R2>,
    ) => <E3, R3>(self: Effect.Effect<O, E3, R3>) => Effect.Effect<Out, E1 | E2 | E3, R1 | R2 | R3>,
    <O, E2, R2, E3, R3>(
      self: Effect.Effect<O, E3, R3>,
      transform: (object: NoInfer<O>) => Effect.Effect<NoInfer<In>, E2, R2>,
...
export const mapEffectifyOptional = <In, Out, E1, R1>(f: (_?: In) => Effect.Effect<Out, E1, R1>) =>
  Function.dual<
    <O, E2, R2>(
      transform?: (object: NoInfer<O>) => Effect.Effect<NoInfer<In>, E2, R2>,
    ) => <E3, R3>(self: Effect.Effect<O, E3, R3>) => Effect.Effect<Out, E1 | E2 | E3, R1 | R2 | R3>,
  ...
  >(
    ...
    <O, E2, R2, E3, R3>(
      ...
      pipe(
        self,
        Effect.flatMap((a) => pipe(transform?.(a) ?? Effect.succeed(undefined), Effect.flatMap(f))),
      ),
  );

export const bindify = <In, Out, E1, R1>(f: (_: In) => Effect.Effect<Out, E1, R1>) =>
  Function.dual<
    <O extends object, N extends string>(
      ...
      self: Effect.Effect<O, E2, R2>,
    ) => Effect.Effect<{ [K in N | keyof O]: K extends keyof O ? O[K] : Out }, E1 | E2, R1 | R2>,
...
export const bindifyOptional = <In, Out, E1, R1>(f: (_?: In) => Effect.Effect<Out, E1, R1>) =>
  Function.dual<
    <O extends object, N extends string>(
      name: Exclude<N, keyof O>,
      transform?: (object: NoInfer<O>) => NoInfer<In>,
...
export const bindEffectify = <In, Out, E1, R1>(f: (_: In) => Effect.Effect<Out, E1, R1>) =>
  Function.dual<
    <O extends object, N extends string, E2, R2>(
      name: Exclude<N, keyof O>,
      transform: (object: NoInfer<O>) => Effect.Effect<NoInfer<In>, E2, R2>,
...
export const bindEffectifyOptional = <In, Out, E1, R1>(f: (_?: In) => Effect.Effect<Out, E1, R1>) =>
  Function.dual<
    <O extends object, N extends string, E2, R2>(
      name: Exclude<N, keyof O>,
      transform?: (object: NoInfer<O>) => Effect.Effect<NoInfer<In>, E2, R2>,
...
export const wrap = <In, Out, E1, R1>(f: (_: In) => Effect.Effect<Out, E1, R1>) => new Wrap({ f });

export const wrapOptional = <In, Out, E1, R1>(f: (_?: In) => Effect.Effect<Out, E1, R1>) =>
  new WrapOptional({ f });
