...
const PartialMutationHandlerConfigTaggedClass: new <
  ...
  >,
>(
  args: Readonly<PartialMutationHandlerConfigData<Name, RequestParams, Response, ResponseError>>,
) => Readonly<PartialMutationHandlerConfigData<Name, RequestParams, Response, ResponseError>> & {
...
export class PartialMutationHandlerConfig<
  ...
  ResponseError extends Option.Option<ResponseErrorConfig<StandardSchemaV1>> = Option.Option<
    ResponseErrorConfig<StandardSchemaV1>
  >,
> extends PartialMutationHandlerConfigTaggedClass<Name, RequestParams, Response, ResponseError> {}
...
export type NameOption<Config extends PartialMutationHandlerConfig> = BaseNameOption<
  Config["data"]
>;
export type NameOrUndefined<Config extends PartialMutationHandlerConfig> = BaseNameOrUndefined<
  Config["data"]
>;

export const name = <const Config extends PartialMutationHandlerConfig>(config: Config) =>
...
export type RequestParamsOrUndefined<Config extends PartialMutationHandlerConfig> =
  BaseRequestParamsOrUndefined<Config["data"]>;

export const requestParams = <const Config extends PartialMutationHandlerConfig>(config: Config) =>
  baseRequestParams(config.data) as RequestParamsOrUndefined<Config>;

export type ResponseOption<Config extends PartialMutationHandlerConfig> = BaseResponseOption<
  Config["data"]
>;
export type ResponseOrUndefined<Config extends PartialMutationHandlerConfig> =
  BaseResponseOrUndefined<Config["data"]>;

export const response = <const Config extends PartialMutationHandlerConfig>(config: Config) =>
...
export type ResponseErrorOrUndefined<Config extends PartialMutationHandlerConfig> =
  BaseResponseErrorOrUndefined<Config["data"]>;

export const responseError = <const Config extends PartialMutationHandlerConfig>(config: Config) =>
