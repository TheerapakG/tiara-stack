...
export type NameOption<Config extends BasePartialHandlerConfig> = Config["name"];
export type NameOrUndefined<Config extends BasePartialHandlerConfig> = GetOrUndefined<
  NameOption<Config>
>;

export const name = <const Config extends BasePartialHandlerConfig>(config: Config) =>
...
export type RequestParamsOption<Config extends BasePartialHandlerConfig> =
  ...
  >
    ? RequestParams
    : never;
export type RequestParamsOrUndefined<Config extends BasePartialHandlerConfig> = GetOrUndefined<
  RequestParamsOption<Config>
>;

export const requestParams = <const Config extends BasePartialHandlerConfig>(config: Config) =>
...
export type ResponseOption<Config extends BasePartialHandlerConfig> =
  Config["response"] extends infer Response extends Option.Option<ResponseConfig<StandardSchemaV1>>
    ? Response
    : never;
export type ResponseOrUndefined<Config extends BasePartialHandlerConfig> = GetOrUndefined<
  ResponseOption<Config>
>;

export const response = <const Config extends BasePartialHandlerConfig>(config: Config) =>
...
export type ResponseErrorOption<Config extends BasePartialHandlerConfig> =
  ...
  >
    ? ResponseError
    : never;
export type ResponseErrorOrUndefined<Config extends BasePartialHandlerConfig> = GetOrUndefined<
  ResponseErrorOption<Config>
>;

export const responseError = <const Config extends BasePartialHandlerConfig>(config: Config) =>
