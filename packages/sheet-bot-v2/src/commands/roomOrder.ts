...
const makeManualSubCommand = Effect.gen(function* () {
  ...
  return yield* CommandHelper.makeSubCommand(
    ...
    Effect.fn("room_order.manual")(function* (command) {
      ...
      const schedules = yield* scheduleService.channelPopulatedSchedules(guildId, channelName);
      ...
      yield* messageRoomOrderService.upsertMessageRoomOrder(
        messageResult.id,
        previousFillNames,
        fillNames,
        hour,
        0,
        Option.getOrUndefined(monitorName),
      );
