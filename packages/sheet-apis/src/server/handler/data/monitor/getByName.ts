import { Monitor, PartialNameMonitor, Error } from "@/server/schema";
import { pipe, Schema } from "effect";
import { Handler } from "typhoon-core/server";
import { Result } from "typhoon-core/schema";

export const monitorGetByNameHandlerData = pipe(
  Handler.Data.empty(),
  Handler.Data.Builder.type("subscription"),
  Handler.Data.Builder.name("monitor.getByName"),
    ...
    validator: pipe(
      Result.ResultSchema({
        optimistic: Schema.Either({
          right: Schema.Array(Schema.Array(Schema.Union(Monitor, PartialNameMonitor))),
          left: Schema.Union(
