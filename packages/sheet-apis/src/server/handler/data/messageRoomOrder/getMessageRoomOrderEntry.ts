...
export const getMessageRoomOrderEntryHandlerData = pipe(
  Handler.Data.empty(),
  Handler.Data.Builder.type("subscription"),
  Handler.Data.Builder.name("messageRoomOrder.getMessageRoomOrderEntry"),
    ...
    validator: pipe(
      Result.ResultSchema({
        optimistic: Schema.Either({
          right: Schema.Array(MessageRoomOrderEntry),
