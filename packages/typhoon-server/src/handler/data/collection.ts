...
export type BaseHandlerDataCollectionRecord = Data.Collection.BaseHandlerDataCollectionRecord<
  MutationHandlerT | SubscriptionHandlerT
>;

export type HandlerDataCollection<CollectionRecord extends BaseHandlerDataCollectionRecord = any> =
  Data.Collection.HandlerDataCollection<MutationHandlerT | SubscriptionHandlerT, CollectionRecord>;
...
export const add =
  ...
  <const C extends HandlerDataCollection>(handlerDataCollection: C) =>
    Data.Collection.add<
      C,
      HandlerT extends Data.Collection.HandlerDataCollectionHandlerT<C> ? HandlerT : never,
      HData
...
export const addGroup =
  <const G extends Data.Group.HandlerDataGroup<any, any>>(handlerDataGroup: G) =>
  <const C extends HandlerDataCollection>(handlerDataCollection: C) =>
...
export const addCollection =
  ...
  <const ThisC extends HandlerDataCollection>(handlerDataCollection: ThisC) =>
    pipe(handlerDataCollection, Data.Collection.addCollection<OtherC>(otherCollection));
...
> = Data.Collection.GetHandlerDataGroup<
  C,
  T extends Type.HandlerType<Data.Collection.HandlerDataCollectionHandlerT<C>> ? T : never
>;

export const getHandlerDataGroup =
  <const C extends HandlerDataCollection, const T extends "mutation" | "subscription">(type: T) =>
  (handlerDataCollection: C) =>
    pipe(
      ...
      Data.Collection.getHandlerDataGroup<
        ...
        T extends Type.HandlerType<Data.Collection.HandlerDataCollectionHandlerT<C>> ? T : never
      >(
        type as T extends Type.HandlerType<Data.Collection.HandlerDataCollectionHandlerT<C>>
          ? T
          : never,
      ),
    );

export const getSubscriptionHandlerDataGroup = <const C extends HandlerDataCollection>(
  handlerDataCollection: C,
) => pipe(handlerDataCollection, getHandlerDataGroup<C, "subscription">("subscription"));

export const getMutationHandlerDataGroup = <const C extends HandlerDataCollection>(
  handlerDataCollection: C,
